...
def get_default_parser():
    ...
    parser.add_argument('--save_dir', type=str, default='/home/zhoujh/ADJSCC-main/sparse_sharing/saved_models')
    ...
    # '/home/zhoujh/code/saved_models/cp/exp1/init_weights.th'
    parser.add_argument('--init_weights', type=str, default='/home/zhoujh/ADJSCC-main/sparse_sharing/saved_models/0-10dB_c16/init_weights.th', help='init weights(checkpoints) for training')
    # parser.add_argument('--init_weights', type=str, default='/home/zhoujh/code/saved_models/10dB_c8/init_weights.th', help='init weights(checkpoints) for training')
    # parser.add_argument('--init_weights', type=str, default='/home/zhoujh/code/1221both_cr0.17_c16_bs128_s_split_best_lr0.001_epochs500_stepsize30.pth', help='init weights(checkpoints) for training')
    ...
    parser.add_argument("--debug", dest='debug', action='store_true', default=True, help='whether to enter debug mode')
    # fmt: on
    return parser
