...
class WITT(nn.Module):
    def __init__(self, args, config):
        ...
        #     config.logging.info("Network config: ")
        #     config.logging.info("Encoder: ")
        #     config.logging.info(encoder_kwargs)
        #     config.logging.info("Decoder: ")
        #     config.logging.info(decoder_kwargs)
